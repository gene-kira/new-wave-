...
# Name: Nereid-lattice-weave-4f067a
# Constraints: zero_emissions, modular, self_healing, fail_safe, transparent, silent
# Params: scale=49.0939, power_budget=1.7298, tol=0.003, mutation_rate=0.8
# Scores: final=0.7805 novelty=0.7614 utility=0.6975 impact=1.0000 curiosity=0.5490
...
class Config:
    def __init__(self):
        self.name = 'Nereid-lattice-weave-4f067a'
...
def main():
    ...
    core = ProjectCore(p, 'materials_weave-quantized_transport-shell_stack-shielding', ['zero_emissions', 'modular', 'self_healing', 'fail_safe', 'transparent', 'silent'], 'shielding')
