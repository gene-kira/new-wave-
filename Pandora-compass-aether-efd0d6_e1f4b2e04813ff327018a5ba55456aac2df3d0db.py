...
# Name: Pandora-compass-aether-efd0d6
...
# Scores: final=0.7571 novelty=0.7445 utility=0.6402 impact=1.0000 curiosity=0.5538
...
class Config:
    def __init__(self):
        self.name = 'Pandora-compass-aether-efd0d6'
...
def main():
    ...
    core = ProjectCore(p, 'optics-turbulence_guidance-spiral_tower-harvesting', ['rapid_deploy', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'zero_emissions', 'modular'], 'harvesting')
