...
def looks_obfuscated_path(path: str) -> bool:
    ...
    # High entropy + weird chars = likely obfuscated/packed
...
# ============================================================
# 9. PROCESS MEMORY SCANNING & DLL INJECTION DETECTION
# ============================================================
...
def scan_memory_maps_for_injection(proc: psutil.Process) -> bool:
    try:
        for m in proc.memory_maps():
            ...
            if not path:
                continue
            # DLL injection heuristic: DLLs loaded from temp, user profile, or odd locations
...
def scan_memory_for_suspicious_strings(proc: psutil.Process) -> bool:
    # User-mode safe approximation: we only look at mapped file paths, not raw memory.
    # Real memory scanning would require a driver or debug privileges.
    try:
        for m in proc.memory_maps():
            path = (m.path or "").lower()
...
# ============================================================
# 11. BEHAVIORAL & AI-STYLE ANOMALY SCORING
# ============================================================
...
def process_behavior_profile(proc: psutil.Process) -> dict:
    ...
    stats["suspicious"] = score >= 10.0  # threshold
...
# ============================================================
# 15. CODEX COCKPIT GUI
# ============================================================
class CodexCockpitGUI:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("Codex Input Firewall — Omega Cockpit")
