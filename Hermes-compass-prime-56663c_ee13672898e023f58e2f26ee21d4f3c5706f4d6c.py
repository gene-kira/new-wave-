# Project: biodesign-feedback_adaptation-queen_board_swarm-mobility
# Name: Hermes-compass-prime-56663c
# Constraints: self_healing, low_mass, scalable, silent, modular, zero_emissions
# Params: scale=469.0015, power_budget=27.1952, tol=0.0045, mutation_rate=0.8
# Scores: final=0.7398 novelty=0.7914 utility=0.6552 impact=0.9000 curiosity=0.5840
...
class Config:
    def __init__(self):
        self.name = 'Hermes-compass-prime-56663c'
        self.title = 'biodesign-feedback_adaptation-queen_board_swarm-mobility'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-feedback_adaptation-queen_board_swarm-mobility', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular', 'zero_emissions'], 'mobility')
