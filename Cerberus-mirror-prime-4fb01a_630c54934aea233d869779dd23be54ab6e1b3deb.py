# Project: energy-nonlinear_coupling-queen_board_swarm-cooling
# Name: Cerberus-mirror-prime-4fb01a
# Constraints: low_power, fail_safe, zero_emissions, self_healing
# Params: scale=1.3076, power_budget=25.2729, tol=0.0272, mutation_rate=0.7256
# Scores: final=0.7660 novelty=0.8507 utility=0.6178 impact=0.9000 curiosity=0.6405
...
class Config:
    def __init__(self):
        self.name = 'Cerberus-mirror-prime-4fb01a'
        self.title = 'energy-nonlinear_coupling-queen_board_swarm-cooling'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'energy-nonlinear_coupling-queen_board_swarm-cooling', ['low_power', 'fail_safe', 'zero_emissions', 'self_healing'], 'cooling')
