...
# Name: Hyperion-swarm-delta-657cd3
...
# Scores: final=0.7496 novelty=0.7384 utility=0.6226 impact=1.0000 curiosity=0.5545
...
class Config:
    def __init__(self):
        self.name = 'Hyperion-swarm-delta-657cd3'
...
def main():
    ...
    core = ProjectCore(p, 'optics-turbulence_guidance-beam_array-harvesting', ['rapid_deploy', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'zero_emissions', 'modular'], 'harvesting')
