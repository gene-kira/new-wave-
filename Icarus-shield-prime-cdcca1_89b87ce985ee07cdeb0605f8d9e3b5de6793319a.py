# Project: energy-turbulence_guidance-beam_array-harvesting
# Name: Icarus-shield-prime-cdcca1
...
# Scores: final=0.7493 novelty=0.7365 utility=0.6240 impact=1.0000 curiosity=0.5527
...
class Config:
    def __init__(self):
        self.name = 'Icarus-shield-prime-cdcca1'
        self.title = 'energy-turbulence_guidance-beam_array-harvesting'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'energy-turbulence_guidance-beam_array-harvesting', ['rapid_deploy', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'zero_emissions', 'modular'], 'harvesting')
