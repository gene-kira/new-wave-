# Project: biodesign-feedback_adaptation-torsion_drive-navigation
# Name: Phoenix-saddle-shade-34b64e
...
# Scores: final=0.7741 novelty=0.8194 utility=0.6009 impact=1.0000 curiosity=0.6224
...
class Config:
    def __init__(self):
        self.name = 'Phoenix-saddle-shade-34b64e'
        self.title = 'biodesign-feedback_adaptation-torsion_drive-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-feedback_adaptation-torsion_drive-navigation', ['zero_emissions', 'fail_safe', 'low_power', 'scalable', 'self_healing'], 'navigation')
