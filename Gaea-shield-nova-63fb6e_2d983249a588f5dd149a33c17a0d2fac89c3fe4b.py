# Project: optics-gradient_control-beam_array-mobility
# Name: Gaea-shield-nova-63fb6e
...
# Scores: final=0.7670 novelty=0.7426 utility=0.6759 impact=1.0000 curiosity=0.5418
...
class Config:
    def __init__(self):
        self.name = 'Gaea-shield-nova-63fb6e'
        self.title = 'optics-gradient_control-beam_array-mobility'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'optics-gradient_control-beam_array-mobility', ['rapid_deploy', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'zero_emissions', 'modular'], 'mobility')
