...
# Name: Cerberus-loom-prime-bb7cfb
...
# Scores: final=0.8039 novelty=0.7768 utility=0.7568 impact=1.0000 curiosity=0.5417
...
class Config:
    def __init__(self):
        self.name = 'Cerberus-loom-prime-bb7cfb'
...
def main():
    ...
    core = ProjectCore(p, 'atmosphere-turbulence_guidance-beam_array-damping', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass'], 'damping')
