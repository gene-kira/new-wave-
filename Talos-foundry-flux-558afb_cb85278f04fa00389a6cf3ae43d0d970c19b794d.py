# Project: computation-lattice_tuning-orbital_kite-harvesting
# Name: Talos-foundry-flux-558afb
...
# Scores: final=0.7778 novelty=0.7734 utility=0.6730 impact=1.0000 curiosity=0.5652
...
class Config:
    def __init__(self):
        self.name = 'Talos-foundry-flux-558afb'
        self.title = 'computation-lattice_tuning-orbital_kite-harvesting'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'computation-lattice_tuning-orbital_kite-harvesting', ['zero_emissions', 'scalable', 'fail_safe', 'low_mass', 'low_power', 'silent'], 'harvesting')
