...
# Scores: final=0.8015 novelty=0.7626 utility=0.7666 impact=1.0000 curiosity=0.5288
...
class Config:
    def __init__(self):
        self.name = 'Atlas-mesh-shade-9b97d3'
...
def main():
    ...
    core = ProjectCore(p, 'atmosphere-resonance-beam_array-navigation', ['zero_emissions', 'modular', 'self_healing', 'scalable', 'fail_safe', 'low_mass', 'low_power'], 'navigation')
