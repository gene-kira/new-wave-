...
# Scores: final=0.7788 novelty=0.7986 utility=0.8990 impact=0.7000 curiosity=0.5114
...
class Config:
    def __init__(self):
        self.name = 'Titan-spiral-arc-ed1a81'
...
def main():
    ...
    core = ProjectCore(p, 'materials_weave-quantized_transport-mesh_network-damping', ['self_healing', 'modular', 'fail_safe', 'transparent', 'silent'], 'damping')
