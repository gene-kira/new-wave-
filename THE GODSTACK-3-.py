...
class GroupPolicyEnforcer:
    """
    Reads policy from Windows registry (if available) or local JSON file.
    Controls telemetry level and potentially other behaviors.
    """
...
class WatchdogOrgan:
    ...
    # --------------------------------------------------------
    #  Register a heartbeat from any subsystem
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    #  Monitor all Python programs in Startup
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    #  Ensure monitored programs are running (local resurrection)
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    #  Swarm broadcast of watchdog state
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    #  Swarm listener for other nodes' watchdog state
    # --------------------------------------------------------
...
WATCHDOG = None  # will be set in main()
