# Project: biodesign-field_weaving-ring_habitat-navigation
# Name: Lyra-loom-shade-e04356
...
# Scores: final=0.7808 novelty=0.7683 utility=1.0272 impact=0.6000 curiosity=0.4526
...
class Config:
    def __init__(self):
        self.name = 'Lyra-loom-shade-e04356'
        self.title = 'biodesign-field_weaving-ring_habitat-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-field_weaving-ring_habitat-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular'], 'navigation')
