...
# Scores: final=0.7734 novelty=0.7938 utility=0.7167 impact=0.9000 curiosity=0.5663
...
class Config:
    def __init__(self):
        self.name = 'Aurora-mesh-echo-317aab'
...
def main():
    ...
    core = ProjectCore(p, 'orbits-feedback_adaptation-shield_skin-cooling', ['zero_emissions', 'modular', 'rapid_deploy', 'fail_safe', 'low_power', 'silent'], 'cooling')
