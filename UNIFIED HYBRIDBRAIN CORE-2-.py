"""
HYBRIDBRAIN v2 – Unified Single File
...
- HybridBrainCore
- Tkinter GUI Control Panel + Library Health
"""
...
class PersistenceLayer:
    ...
    def get_recent_weights(self, limit: int = 100) -> List[Tuple]:
        conn = sqlite3.connect(self.db_path)
        cur = conn.cursor()
        cur.execute("""
...
# ============================================================
# TKINTER GUI CONTROL PANEL + LIB HEALTH
# ============================================================
...
def launch_gui(core: HybridBrainCore):
    ...
    root = tk.Tk()
    root.title("HybridBrain v2 Control Panel")
