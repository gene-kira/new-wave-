# Project: orbits-field_weaving-beam_array-shielding
# Name: Helios-bridge-flux-99a002
...
# Scores: final=0.7655 novelty=0.7592 utility=0.6497 impact=1.0000 curiosity=0.5619
...
class Config:
    def __init__(self):
        self.name = 'Helios-bridge-flux-99a002'
        self.title = 'orbits-field_weaving-beam_array-shielding'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'orbits-field_weaving-beam_array-shielding', ['zero_emissions', 'modular', 'scalable', 'rapid_deploy', 'self_healing', 'fail_safe', 'low_mass'], 'shielding')
