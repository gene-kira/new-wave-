...
# Scores: final=0.7766 novelty=0.7554 utility=0.6918 impact=1.0000 curiosity=0.5463
...
class Config:
    def __init__(self):
        self.name = 'Icarus-garden-x-82ad33'
...
def main():
    ...
    core = ProjectCore(p, 'materials_weave-quantized_transport-ring_habitat-shielding', ['zero_emissions', 'modular', 'self_healing', 'fail_safe', 'transparent', 'silent'], 'shielding')
