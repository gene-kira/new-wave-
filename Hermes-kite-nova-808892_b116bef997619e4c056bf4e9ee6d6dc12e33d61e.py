...
# Scores: final=0.8033 novelty=0.7719 utility=0.7609 impact=1.0000 curiosity=0.5370
...
class Config:
    def __init__(self):
        self.name = 'Hermes-kite-nova-808892'
...
def main():
    ...
    core = ProjectCore(p, 'optics-turbulence_guidance-beam_array-navigation', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'rapid_deploy', 'fail_safe', 'low_mass'], 'navigation')
