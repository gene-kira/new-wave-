# Project: gravity-feedback_adaptation-shield_skin-cooling
# Name: Nereid-mirror-x-120a0b
...
# Scores: final=0.7749 novelty=0.7941 utility=0.7215 impact=0.9000 curiosity=0.5649
...
class Config:
    def __init__(self):
        self.name = 'Nereid-mirror-x-120a0b'
        self.title = 'gravity-feedback_adaptation-shield_skin-cooling'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'gravity-feedback_adaptation-shield_skin-cooling', ['zero_emissions', 'modular', 'rapid_deploy', 'fail_safe', 'low_power', 'silent'], 'cooling')
