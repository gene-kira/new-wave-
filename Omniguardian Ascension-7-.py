...
# ============================================================
# Codex Sentinel Forklift Node v14 – Neural Swarm Overmind++ Borg
#
...
class UniversalOSLoader:
    ...
    def _normalize_env(self):
        ...
        borg_dir = self.base_path / "borg"
        borg_dir.mkdir(exist_ok=True)
        self.env["BORG_DIR"] = str(borg_dir)
...
def _record_replay_snapshot():
    snapshot = {
        ...
        "borg": SYSTEM_GUARDIAN_STATS.get("borg", {}),
    }
...
def _explain_guardian_state():
    ...
    borg_global = SYSTEM_GUARDIAN_STATS["borg"]["global_load"]
...
def system_guardian_loop():
    ...
    while True:
        try:
            ...
            SYSTEM_GUARDIAN_STATS["borg"]["global_load"] = borg_compute_global_load()
...
# ============================================================
# Tkinter GUI dashboard (graphs, risk heatmap, event timeline, borg load)
# ============================================================
...
def main():
    ...
    if args.headless_node:
        print(f"[Node] Running in headless RPC+Borg mode on {OSLOADER.os}, profile={args.game_profile}, node_id={args.node_id}.")
        try:
            while True:
                time.sleep(3600)
        except KeyboardInterrupt:
