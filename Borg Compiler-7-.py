...
class Optimizer:
    ...
    # Predictive / probabilistic triggers
    def predictive_gap_detection(self, tree: ast.AST) -> bool:
        # crude heuristic: if there are many Name loads with no defs, assume missing details
        defined = set()
        used = set()
...
# ---------------------------------------------------------------------------
# CodeGenerator: AST-based Borg Compiler core + predictive layer
# ---------------------------------------------------------------------------
class CodeGenerator:
    def __init__(self, optimizer: Optimizer):
        ...
        # predictive / probabilistic engines
        self.queen = Queen()
    ...
    def predictive_gap_annotate(self, tree: ast.AST) -> ast.AST:
        # Use ProbabilisticField + Queen + AttackChain to annotate "missing detail" risk
        missing_vars = []
...
class BorgCompilerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Borg Compiler v8.0 - Predictive Consciousness Edition")
...
def main():
    parser = argparse.ArgumentParser(
        description="Borg Compiler v8.0 - Predictive Consciousness Edition"
    )
    parser.add_argument(
        "--server_host",
        type=str,
