...
# Scores: final=0.7958 novelty=0.7551 utility=0.7567 impact=1.0000 curiosity=0.5266
...
class Config:
    def __init__(self):
        self.name = 'Titan-harbor-x-52be50'
...
def main():
    ...
    core = ProjectCore(p, 'atmosphere-gradient_control-beam_array-navigation', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'transparent'], 'navigation')
