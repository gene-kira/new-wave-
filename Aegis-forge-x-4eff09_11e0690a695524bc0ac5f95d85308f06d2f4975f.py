...
# Scores: final=0.8007 novelty=0.7613 utility=0.7655 impact=1.0000 curiosity=0.5281
...
class Config:
    def __init__(self):
        self.name = 'Aegis-forge-x-4eff09'
...
def main():
    ...
    core = ProjectCore(p, 'energy-resonance-beam_array-navigation', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'low_power'], 'navigation')
