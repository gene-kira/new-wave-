...
# Scores: final=0.7986 novelty=0.7629 utility=0.7566 impact=1.0000 curiosity=0.5320
...
class Config:
    def __init__(self):
        self.name = 'Gaea-lattice-echo-00fbd1'
...
def main():
    ...
    core = ProjectCore(p, 'gravity-turbulence_guidance-beam_array-navigation', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'transparent'], 'navigation')
