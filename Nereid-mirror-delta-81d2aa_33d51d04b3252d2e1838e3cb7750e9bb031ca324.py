# Project: magnetism-resonance-saddle_coil-navigation
# Name: Nereid-mirror-delta-81d2aa
# Constraints: silent, low_mass, zero_emissions, low_power
# Params: scale=87.1748, power_budget=11458.161, tol=0.0619, mutation_rate=0.1641
# Scores: final=0.6964 novelty=0.8498 utility=0.5517 impact=0.7000 curiosity=0.6623
...
class Config:
    def __init__(self):
        self.name = 'Nereid-mirror-delta-81d2aa'
        self.title = 'magnetism-resonance-saddle_coil-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    p = Parameters(scale=87.1748, power_budget=11458.161, tolerance=0.0619, mutation_rate=0.1641)
    errs = validate_params(p)
    if errs:
        logging.error('Validation errors: %s', errs); sys.exit(1)
    core = ProjectCore(p, 'magnetism-resonance-saddle_coil-navigation', ['silent', 'low_mass', 'zero_emissions', 'low_power'], 'navigation')
