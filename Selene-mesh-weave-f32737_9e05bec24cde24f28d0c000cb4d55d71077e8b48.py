...
# Scores: final=0.7914 novelty=0.8109 utility=1.0121 impact=0.6000 curiosity=0.4826
...
class Config:
    def __init__(self):
        self.name = 'Selene-mesh-weave-f32737'
...
def main():
    ...
    core = ProjectCore(p, 'plasma-feedback_adaptation-ring_habitat-navigation', ['modular', 'scalable', 'silent', 'low_mass', 'self_healing'], 'navigation')
