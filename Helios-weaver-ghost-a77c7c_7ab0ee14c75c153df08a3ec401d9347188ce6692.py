...
# Name: Helios-weaver-ghost-a77c7c
...
# Scores: final=0.8050 novelty=0.7788 utility=0.7581 impact=1.0000 curiosity=0.5426
...
class Config:
    def __init__(self):
        self.name = 'Helios-weaver-ghost-a77c7c'
...
def main():
    ...
    core = ProjectCore(p, 'atmosphere-turbulence_guidance-shield_skin-damping', ['zero_emissions', 'modular', 'self_healing', 'scalable', 'fail_safe', 'low_mass'], 'damping')
