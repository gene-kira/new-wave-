# Project: materials_weave-resonance-ring_habitat-shielding
# Name: Icarus-glider-arc-cd44c5
...
# Scores: final=0.8458 novelty=0.7717 utility=0.9049 impact=1.0000 curiosity=0.4924
...
class Config:
    def __init__(self):
        self.name = 'Icarus-glider-arc-cd44c5'
        self.title = 'materials_weave-resonance-ring_habitat-shielding'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'materials_weave-resonance-ring_habitat-shielding', ['self_healing', 'silent', 'fail_safe', 'modular', 'zero_emissions', 'transparent'], 'shielding')
