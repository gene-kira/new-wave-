...
# Scores: final=0.7852 novelty=0.7675 utility=0.7055 impact=1.0000 curiosity=0.5509
...
class Config:
    def __init__(self):
        self.name = 'Talos-tower-pulse-3bc2bf'
...
def main():
    ...
    core = ProjectCore(p, 'computation-turbulence_guidance-beam_array-cooling', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass'], 'cooling')
