...
# ---------------------------------------------------------------------------
# SSA, CFG, Data-flow, Semantic structures (simplified)
# ---------------------------------------------------------------------------
class CFGNode:
...
class BorgCompilerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Borg Compiler v4.0 - Full-stack AST/CFG/SSA Optimizer")
...
def main():
    parser = argparse.ArgumentParser(
        description="Borg Compiler v4.0 - Full-stack AST/CFG/SSA/Dataflow optimizer with aggressive autoloader"
    )
    parser.add_argument(
        "--server_host",
        type=str,
