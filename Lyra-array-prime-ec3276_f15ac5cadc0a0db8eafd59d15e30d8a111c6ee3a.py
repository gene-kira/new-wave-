# Project: materials-nonlinear_coupling-ring_habitat-navigation
# Name: Lyra-array-prime-ec3276
...
# Scores: final=0.7818 novelty=0.7794 utility=1.0173 impact=0.6000 curiosity=0.4623
...
class Config:
    def __init__(self):
        self.name = 'Lyra-array-prime-ec3276'
        self.title = 'materials-nonlinear_coupling-ring_habitat-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'materials-nonlinear_coupling-ring_habitat-navigation', ['modular', 'scalable', 'silent', 'low_mass', 'self_healing'], 'navigation')
