...
# Name: Selene-weaver-shade-29eeb2
# Constraints: zero_emissions, fail_safe, low_power, scalable, self_healing
# Params: scale=590.2977, power_budget=5477.5592, tol=0.003, mutation_rate=0.8
# Scores: final=0.7722 novelty=0.7825 utility=0.6423 impact=1.0000 curiosity=0.5815
...
class Config:
    def __init__(self):
        self.name = 'Selene-weaver-shade-29eeb2'
...
def main():
    ...
    p = Parameters(scale=590.2977, power_budget=5477.5592, tolerance=0.003, mutation_rate=0.8)
    errs = validate_params(p)
    if errs:
        logging.error('Validation errors: %s', errs); sys.exit(1)
    core = ProjectCore(p, 'biodesign-feedback_adaptation-spiral_tower-amplification', ['zero_emissions', 'fail_safe', 'low_power', 'scalable', 'self_healing'], 'amplification')
