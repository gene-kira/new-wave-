...
# Name: Aurora-mesh-nova-fd2f57
# Constraints: zero_emissions, modular, self_healing, scalable, rapid_deploy, fail_safe, low_mass
# Params: scale=381.5841, power_budget=0.189, tol=0.003, mutation_rate=0.8
# Scores: final=0.7967 novelty=0.7590 utility=0.7549 impact=1.0000 curiosity=0.5298
...
class Config:
    def __init__(self):
        self.name = 'Aurora-mesh-nova-fd2f57'
...
def main():
    ...
    p = Parameters(scale=381.5841, power_budget=0.189, tolerance=0.003, mutation_rate=0.8)
    errs = validate_params(p)
    if errs:
        logging.error('Validation errors: %s', errs); sys.exit(1)
    core = ProjectCore(p, 'atmosphere-gradient_control-beam_array-navigation', ['zero_emissions', 'modular', 'self_healing', 'scalable', 'rapid_deploy', 'fail_safe', 'low_mass'], 'navigation')
