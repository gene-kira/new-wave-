...
# Name: Icarus-sphere-weave-01c297
# Constraints: zero_emissions, modular, self_healing, scalable, fail_safe, low_mass
# Params: scale=318.57, power_budget=0.5656, tol=0.0037, mutation_rate=0.8
# Scores: final=0.8129 novelty=0.8205 utility=0.7321 impact=1.0000 curiosity=0.5802
...
class Config:
    def __init__(self):
        self.name = 'Icarus-sphere-weave-01c297'
...
def main():
    ...
    p = Parameters(scale=318.57, power_budget=0.5656, tolerance=0.0037, mutation_rate=0.8)
