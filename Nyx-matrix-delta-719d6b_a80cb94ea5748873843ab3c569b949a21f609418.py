...
# Scores: final=0.7830 novelty=0.7863 utility=1.0131 impact=0.6000 curiosity=0.4677
...
class Config:
    def __init__(self):
        self.name = 'Nyx-matrix-delta-719d6b'
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-nonlinear_coupling-spiral_tower-navigation', ['modular', 'scalable', 'silent', 'low_mass', 'self_healing'], 'navigation')
