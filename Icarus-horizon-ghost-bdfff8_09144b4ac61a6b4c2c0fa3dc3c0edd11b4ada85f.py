...
# Name: Icarus-horizon-ghost-bdfff8
# Constraints: self_healing, scalable, silent, fail_safe, modular, zero_emissions
# Params: scale=0.0992, power_budget=0.1733, tol=0.003, mutation_rate=0.8
# Scores: final=0.7832 novelty=0.7677 utility=0.6985 impact=1.0000 curiosity=0.5532
...
class Config:
    def __init__(self):
        self.name = 'Icarus-horizon-ghost-bdfff8'
...
def main():
    ...
    p = Parameters(scale=0.0992, power_budget=0.1733, tolerance=0.003, mutation_rate=0.8)
    errs = validate_params(p)
    if errs:
        logging.error('Validation errors: %s', errs); sys.exit(1)
    core = ProjectCore(p, 'materials-gradient_control-beam_array-shielding', ['self_healing', 'scalable', 'silent', 'fail_safe', 'modular', 'zero_emissions'], 'shielding')
