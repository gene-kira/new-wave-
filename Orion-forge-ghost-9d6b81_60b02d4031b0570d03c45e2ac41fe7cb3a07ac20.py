...
# Name: Orion-forge-ghost-9d6b81
# Constraints: silent, fail_safe, transparent, zero_emissions, modular, self_healing
# Params: scale=44.6324, power_budget=0.8048, tol=0.003, mutation_rate=0.8
# Scores: final=0.7740 novelty=0.7462 utility=0.6947 impact=1.0000 curiosity=0.5388
...
class Config:
    def __init__(self):
        self.name = 'Orion-forge-ghost-9d6b81'
...
def main():
    ...
    p = Parameters(scale=44.6324, power_budget=0.8048, tolerance=0.003, mutation_rate=0.8)
    errs = validate_params(p)
    if errs:
        logging.error('Validation errors: %s', errs); sys.exit(1)
    core = ProjectCore(p, 'materials_weave-lattice_tuning-queen_board_swarm-shielding', ['silent', 'fail_safe', 'transparent', 'zero_emissions', 'modular', 'self_healing'], 'shielding')
