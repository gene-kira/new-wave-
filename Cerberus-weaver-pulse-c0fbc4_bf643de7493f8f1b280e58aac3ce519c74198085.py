# Project: biodesign-turbulence_guidance-orbital_kite-navigation
# Name: Cerberus-weaver-pulse-c0fbc4
...
# Scores: final=0.7633 novelty=0.7280 utility=0.6820 impact=1.0000 curiosity=0.5294
...
class Config:
    def __init__(self):
        self.name = 'Cerberus-weaver-pulse-c0fbc4'
        self.title = 'biodesign-turbulence_guidance-orbital_kite-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-turbulence_guidance-orbital_kite-navigation', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'transparent'], 'navigation')
