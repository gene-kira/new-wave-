...
# Name: Cerberus-tower-weave-0ff6b9
# Constraints: modular, self_healing, scalable, fail_safe, transparent, silent
# Params: scale=38.2226, power_budget=1.2286, tol=0.003, mutation_rate=0.8
# Scores: final=0.7123 novelty=0.7378 utility=0.6660 impact=0.8000 curiosity=0.5413
...
class Config:
    def __init__(self):
        self.name = 'Cerberus-tower-weave-0ff6b9'
...
def main():
    ...
    core = ProjectCore(p, 'materials_weave-phase_modulation-mesh_network-damping', ['modular', 'self_healing', 'scalable', 'fail_safe', 'transparent', 'silent'], 'damping')
