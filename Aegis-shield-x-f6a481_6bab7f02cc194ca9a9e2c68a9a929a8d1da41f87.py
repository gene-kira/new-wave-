...
# Scores: final=0.7902 novelty=0.7652 utility=0.7253 impact=1.0000 curiosity=0.5432
...
class Config:
    def __init__(self):
        self.name = 'Aegis-shield-x-f6a481'
...
def main():
    ...
    core = ProjectCore(p, 'atmosphere-turbulence_guidance-beam_array-navigation', ['zero_emissions', 'modular', 'self_healing', 'scalable', 'fail_safe', 'low_mass'], 'navigation')
