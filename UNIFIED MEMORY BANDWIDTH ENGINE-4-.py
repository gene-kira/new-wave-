#!/usr/bin/env python3
# ============================================================
# HybridBrain Unified Memory Daemon v4
# Mode: Pure backend organism (no GUI, maximum performance)
# Focus: Real workload integration (files + network streams)
# ============================================================
...
WORKLOAD_SCAN_DIR = "hb_workload"   # directory for real file workload
...
# ============================================================
# REAL WORKLOAD MANAGER (Files + Network)
# ============================================================
...
class WorkloadManager:
    def __init__(self, engine: UnifiedMemoryEngine):
        ...
        log_info("[WORKLOAD] Manager started (files + network)")
                    ...
                    try:
                        with open(path, "rb") as f:
                            ...
                            while True:
                                ...
                                _ = self.engine.read(key, size=min(len(chunk), 1024 * 1024))
                                chunk_id += 1
                ...
                with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                    try:
                        ...
                        while self.running:
                            ...
                            _ = self.engine.read(key, size=min(len(data), 1024 * 1024))
                    except Exception as e:
