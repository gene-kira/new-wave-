# Project: biodesign-nonlinear_coupling-beam_array-navigation
# Name: Prometheus-harbor-arc-2859d1
# Constraints: self_healing, low_mass, scalable, silent, modular
# Params: scale=164.9078, power_budget=31.3709, tol=0.003, mutation_rate=0.8
# Scores: final=0.7659 novelty=0.7636 utility=0.9824 impact=0.6000 curiosity=0.4635
...
class Config:
    def __init__(self):
        self.name = 'Prometheus-harbor-arc-2859d1'
        self.title = 'biodesign-nonlinear_coupling-beam_array-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-nonlinear_coupling-beam_array-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular'], 'navigation')
