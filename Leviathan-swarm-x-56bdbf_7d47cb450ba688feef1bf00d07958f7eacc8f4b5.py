# Project: biodesign-nonlinear_coupling-orbital_kite-navigation
# Name: Leviathan-swarm-x-56bdbf
...
# Scores: final=0.7583 novelty=0.7357 utility=0.6552 impact=1.0000 curiosity=0.5428
...
class Config:
    def __init__(self):
        self.name = 'Leviathan-swarm-x-56bdbf'
        self.title = 'biodesign-nonlinear_coupling-orbital_kite-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-nonlinear_coupling-orbital_kite-navigation', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'transparent'], 'navigation')
