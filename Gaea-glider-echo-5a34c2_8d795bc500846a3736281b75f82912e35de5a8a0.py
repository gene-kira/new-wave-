# Project: magnetism-topology_shaping-torsion_drive-damping
# Name: Gaea-glider-echo-5a34c2
...
# Scores: final=0.7798 novelty=0.7717 utility=0.6819 impact=1.0000 curiosity=0.5612
...
class Config:
    def __init__(self):
        self.name = 'Gaea-glider-echo-5a34c2'
        self.title = 'magnetism-topology_shaping-torsion_drive-damping'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'magnetism-topology_shaping-torsion_drive-damping', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass'], 'damping')
