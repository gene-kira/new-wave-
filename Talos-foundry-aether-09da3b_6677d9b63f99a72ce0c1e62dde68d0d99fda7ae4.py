...
# Name: Talos-foundry-aether-09da3b
...
# Scores: final=0.7954 novelty=0.7902 utility=0.8807 impact=0.8000 curiosity=0.5118
...
class Config:
    def __init__(self):
        self.name = 'Talos-foundry-aether-09da3b'
...
def main():
    ...
    core = ProjectCore(p, 'materials_weave-turbulence_guidance-mesh_network-damping', ['self_healing', 'scalable', 'silent', 'fail_safe', 'modular', 'transparent'], 'damping')
