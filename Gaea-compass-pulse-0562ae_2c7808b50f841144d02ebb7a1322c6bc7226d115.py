# Project: biodesign-topology_shaping-shell_stack-navigation
# Name: Gaea-compass-pulse-0562ae
...
# Scores: final=0.7690 novelty=0.7682 utility=0.9876 impact=0.6000 curiosity=0.4647
...
class Config:
    def __init__(self):
        self.name = 'Gaea-compass-pulse-0562ae'
        self.title = 'biodesign-topology_shaping-shell_stack-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-topology_shaping-shell_stack-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular'], 'navigation')
