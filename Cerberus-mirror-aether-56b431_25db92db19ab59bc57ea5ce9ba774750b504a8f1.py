...
# Name: Cerberus-mirror-aether-56b431
...
# Scores: final=0.7764 novelty=0.7811 utility=0.6582 impact=1.0000 curiosity=0.5754
...
class Config:
    def __init__(self):
        self.name = 'Cerberus-mirror-aether-56b431'
