...
# Name: Leviathan-garden-prime-8672c9
# Constraints: zero_emissions, scalable, fail_safe, low_mass, low_power, silent
# Params: scale=0.0055, power_budget=0.2007, tol=0.0109, mutation_rate=0.8
# Scores: final=0.7955 novelty=0.8182 utility=0.6757 impact=1.0000 curiosity=0.5970
...
class Config:
    def __init__(self):
        self.name = 'Leviathan-garden-prime-8672c9'
...
def main():
    ...
    p = Parameters(scale=0.0055, power_budget=0.2007, tolerance=0.0109, mutation_rate=0.8)
