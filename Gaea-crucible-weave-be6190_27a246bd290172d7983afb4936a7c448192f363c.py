# Project: plasma-gradient_control-ring_habitat-navigation
# Name: Gaea-crucible-weave-be6190
# Constraints: self_healing, low_mass, rapid_deploy, scalable, silent, modular
# Params: scale=709.6448, power_budget=35.9101, tol=0.003, mutation_rate=0.8
# Scores: final=0.7877 novelty=0.7994 utility=1.0132 impact=0.6000 curiosity=0.4755
...
class Config:
    def __init__(self):
        self.name = 'Gaea-crucible-weave-be6190'
        self.title = 'plasma-gradient_control-ring_habitat-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'plasma-gradient_control-ring_habitat-navigation', ['self_healing', 'low_mass', 'rapid_deploy', 'scalable', 'silent', 'modular'], 'navigation')
