# Project: plasma-lattice_tuning-ring_habitat-navigation
# Name: Rhea-tower-ghost-894681
...
# Scores: final=0.7707 novelty=0.7648 utility=0.9973 impact=0.6000 curiosity=0.4597
...
class Config:
    def __init__(self):
        self.name = 'Rhea-tower-ghost-894681'
        self.title = 'plasma-lattice_tuning-ring_habitat-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'plasma-lattice_tuning-ring_habitat-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular'], 'navigation')
