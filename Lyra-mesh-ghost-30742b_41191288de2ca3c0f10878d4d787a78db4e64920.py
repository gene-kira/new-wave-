...
# Scores: final=0.7663 novelty=0.7374 utility=0.6799 impact=1.0000 curiosity=0.5369
...
class Config:
    def __init__(self):
        self.name = 'Lyra-mesh-ghost-30742b'
...
def main():
    ...
    core = ProjectCore(p, 'optics-gradient_control-mesh_network-shielding', ['zero_emissions', 'modular', 'scalable', 'self_healing', 'fail_safe', 'low_mass', 'transparent'], 'shielding')
