...
# Scores: final=0.7665 novelty=0.7512 utility=0.6630 impact=1.0000 curiosity=0.5520
...
class Config:
    def __init__(self):
        self.name = 'Gaea-mesh-ghost-22f1dc'
...
def main():
    ...
    core = ProjectCore(p, 'plasma-quantized_transport-shell_stack-cooling', ['scalable', 'self_healing', 'fail_safe', 'low_mass', 'zero_emissions', 'modular', 'low_power'], 'cooling')
