"""
HYBRIDBRAIN v4 – Monolithic, OS-Adaptive, Headless/GUI/Web, Portable-Ready
...
- HybridBrainCore (with organ scheduler + preload daemon)
...
- Web GUI (Flask) if Tkinter unavailable or explicitly requested
...
# ============================================================
# PERSISTENCE LAYER (SQLite) + COGNITIVE TIMELINE v2
# ============================================================
...
class NeuralSpineBus:
    ...
    def publish(self, msg: SpineMessage):
        ...
        # reflex channel could be handled differently; here we just call directly
        for organ in subs:
...
# ============================================================
# HYBRID WEIGHT ORGAN (unchanged core logic)
# ============================================================
...
# ============================================================
# HYBRID BRAIN CORE + ORGAN SCHEDULER
# ============================================================
...
class HybridBrainCore:
    ...
    # Simple organ scheduler: periodically runs a cognition step
...
def launch_tk_gui(core: HybridBrainCore):
    ...
    root = tk.Tk()
    root.title("HybridBrain v4 – Control Panel")
...
def run_headless(core: HybridBrainCore):
    ...
    print("Running HybridBrain v4 in headless mode.")
    out = core.cognition_step()
...
def main():
    ...
    # Try Tk GUI first; if not possible, try Web GUI; else headless
