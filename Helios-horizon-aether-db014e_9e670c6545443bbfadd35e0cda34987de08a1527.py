...
# Name: Helios-horizon-aether-db014e
...
# Scores: final=0.7618 novelty=0.7643 utility=0.6306 impact=1.0000 curiosity=0.5716
...
class Config:
    def __init__(self):
        self.name = 'Helios-horizon-aether-db014e'
