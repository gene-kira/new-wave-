...
# Name: Borealis-tower-prime-59f954
...
# Scores: final=0.7779 novelty=0.7580 utility=1.0297 impact=0.6000 curiosity=0.4458
...
class Config:
    def __init__(self):
        self.name = 'Borealis-tower-prime-59f954'
...
def main():
    ...
    core = ProjectCore(p, 'plasma-feedback_adaptation-ring_habitat-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular'], 'navigation')
