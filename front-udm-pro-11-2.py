...
- DPI (HTTP/TLS/JA3-like), signatures, persona AI, deception, honeypots, swarm cluster
- GUI-first startup, subsystems start after GUI, errors shown in GUI
- Windows service mode for headless operation

Requires:
- WinDivert driver installed
- pydivert (`pip install pydivert`)
- psutil, requests, pywin32, tkinter
"""
...
class AISecurityBridgeApp:
    def __init__(self, root):
        ...
        # GUI-first: subsystems start after window is up
