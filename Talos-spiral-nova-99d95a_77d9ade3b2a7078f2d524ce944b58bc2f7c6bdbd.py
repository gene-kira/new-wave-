...
# Name: Talos-spiral-nova-99d95a
# Constraints: self_healing, low_mass, scalable, silent, modular, zero_emissions
# Params: scale=801.5435, power_budget=29.8782, tol=0.003, mutation_rate=0.8
# Scores: final=0.8669 novelty=0.7715 utility=1.0608 impact=0.9000 curiosity=0.4441
...
class Config:
    def __init__(self):
        self.name = 'Talos-spiral-nova-99d95a'
...
def main():
    ...
    p = Parameters(scale=801.5435, power_budget=29.8782, tolerance=0.003, mutation_rate=0.8)
    errs = validate_params(p)
    if errs:
        logging.error('Validation errors: %s', errs); sys.exit(1)
    core = ProjectCore(p, 'biodesign-feedback_adaptation-queen_board_swarm-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular', 'zero_emissions'], 'navigation')
