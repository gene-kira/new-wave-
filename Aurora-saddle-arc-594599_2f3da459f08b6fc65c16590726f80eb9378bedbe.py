...
# Scores: final=0.7994 novelty=0.7656 utility=0.7558 impact=1.0000 curiosity=0.5341
...
class Config:
    def __init__(self):
        self.name = 'Aurora-saddle-arc-594599'
...
def main():
    ...
    core = ProjectCore(p, 'atmosphere-field_weaving-beam_array-navigation', ['zero_emissions', 'modular', 'self_healing', 'scalable', 'rapid_deploy', 'fail_safe', 'low_mass'], 'navigation')
