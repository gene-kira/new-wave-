# Project: computation-nonlinear_coupling-orbital_kite-mobility
# Name: Borealis-mirror-weave-58bb1a
...
# Scores: final=0.7763 novelty=0.7695 utility=0.6730 impact=1.0000 curiosity=0.5623
...
class Config:
    def __init__(self):
        self.name = 'Borealis-mirror-weave-58bb1a'
        self.title = 'computation-nonlinear_coupling-orbital_kite-mobility'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'computation-nonlinear_coupling-orbital_kite-mobility', ['zero_emissions', 'scalable', 'fail_safe', 'low_mass', 'low_power', 'silent'], 'mobility')
