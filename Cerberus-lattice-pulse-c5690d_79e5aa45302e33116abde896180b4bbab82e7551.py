...
# Name: Cerberus-lattice-pulse-c5690d
...
# Scores: final=0.7604 novelty=0.7757 utility=0.6595 impact=1.0000 curiosity=0.5711
...
class Config:
    def __init__(self):
        self.name = 'Cerberus-lattice-pulse-c5690d'
...
def main():
    ...
    core = ProjectCore(p, 'gravity-resonance-beam_array-navigation', ['zero_emissions', 'modular', 'self_healing', 'scalable', 'fail_safe', 'low_mass'], 'navigation')
