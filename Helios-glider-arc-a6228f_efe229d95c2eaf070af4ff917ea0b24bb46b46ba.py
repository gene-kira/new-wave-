# Project: plasma-phase_modulation-ring_habitat-navigation
# Name: Helios-glider-arc-a6228f
...
# Scores: final=0.7786 novelty=0.7577 utility=1.0325 impact=0.6000 curiosity=0.4448
...
class Config:
    def __init__(self):
        self.name = 'Helios-glider-arc-a6228f'
        self.title = 'plasma-phase_modulation-ring_habitat-navigation'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'plasma-phase_modulation-ring_habitat-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular'], 'navigation')
