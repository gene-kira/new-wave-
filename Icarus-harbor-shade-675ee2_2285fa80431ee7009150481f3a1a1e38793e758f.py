...
# Name: Icarus-harbor-shade-675ee2
...
# Scores: final=0.7826 novelty=0.7865 utility=1.0117 impact=0.6000 curiosity=0.4682
...
class Config:
    def __init__(self):
        self.name = 'Icarus-harbor-shade-675ee2'
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-nonlinear_coupling-shell_stack-navigation', ['self_healing', 'low_mass', 'scalable', 'silent', 'modular'], 'navigation')
