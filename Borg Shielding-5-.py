...
# =========================
# OS helpers (netstat/ss + firewall + process mapping)
# =========================
...
# =========================
# Hybrid Worker (netstat + optional pcap)
# =========================
...
# =========================
# GUI (Tabbed Threat Matrix)
# =========================

class BorgShieldGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Borg Hybrid Brain + Shield")
    ...
    def build_layout(self):
        ...
        detail_frame = ttk.LabelFrame(main, text="Selected Threat Detail")
