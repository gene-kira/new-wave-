# Project: biodesign-nonlinear_coupling-orbital_kite-harvesting
# Name: Borealis-engine-prime-fc9c7b
...
# Scores: final=0.7785 novelty=0.7752 utility=0.6731 impact=1.0000 curiosity=0.5665
...
class Config:
    def __init__(self):
        self.name = 'Borealis-engine-prime-fc9c7b'
        self.title = 'biodesign-nonlinear_coupling-orbital_kite-harvesting'
        self.seed = 42
        self.iterations = 200
...
def main():
    ...
    core = ProjectCore(p, 'biodesign-nonlinear_coupling-orbital_kite-harvesting', ['zero_emissions', 'scalable', 'fail_safe', 'low_mass', 'low_power', 'silent'], 'harvesting')
