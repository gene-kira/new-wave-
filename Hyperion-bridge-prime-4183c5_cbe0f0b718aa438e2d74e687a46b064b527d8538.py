...
# Name: Hyperion-bridge-prime-4183c5
...
# Scores: final=0.7941 novelty=0.7658 utility=0.7377 impact=1.0000 curiosity=0.5398
...
class Config:
    def __init__(self):
        self.name = 'Hyperion-bridge-prime-4183c5'
...
def main():
    ...
    core = ProjectCore(p, 'atmosphere-gradient_control-beam_array-navigation', ['zero_emissions', 'modular', 'self_healing', 'scalable', 'fail_safe', 'low_mass'], 'navigation')
